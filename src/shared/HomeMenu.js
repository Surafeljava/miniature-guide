...
function HomeMenu() {
    return (
        <div className="relative w-full min-h-screen">
            ...
            <div className="absolute w-full p-6 lg:p-40 grid grid-cols-4 gap-6">
                {pageLinks.map((link) => {
                    return (
                        <div className="col-span-4 md:col-span-1 pt-4 flex flex-col items-start bg-transparent hover:z-10  duration-200 rounded-xl h-[280px]">
                            <Link to={link.to} 
